...
const getSnapshot = (connection, programAddresses) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (true) {
        ...
        const multipleAccountInfos = yield connection.getMultipleAccountsInfo(addressesToGetAccountInfoFor);
        ...
        const rawSupply = spl_token_1.MintLayout.decode(stSolMintAccountInfo.data).supply;
        const amount = new bn_js_1.default(rawSupply.reverse());
